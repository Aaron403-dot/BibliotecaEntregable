...
public interface Prestamista {
	 ...
	 * @param RecursoBiblioteca: usando la clase padre puede recibir cualquiera de las clases hijos en este caso para la devolucion
	 ...
	 * @param Scanner: el input para la selecion de plan
	 ...
	 * @param Scanner: el input para la confirmacion o desconfirmacion de la baja
	 * @return Usuario: el cambio realizado al usaurio
	 * */
